...
async def bot_start(event):
    ...
    if chat.id != Config.OWNER_ID:
        ...
        buttons = [
            (
                Button.url("SouRce TeleGod", "https://t.me/sr_TeleGod"),
                Button.url(
                    "Salah Hemdan",
        ...
        buttons = [
            [
                Button.url("• السورس •", "https://t.me/sr_TeleGod"),
            ],
            [
